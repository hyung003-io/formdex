...
**purpose**: conversational entry point. gathers PDF url, classes, and config from the user, then orchestrates the pipeline.

**location**: `.agents/skills/formdex/SKILL.md`
